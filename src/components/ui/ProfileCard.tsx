...
const ProfileCardComponent: React.FC<ProfileCardProps> = ({
    ...
    const handlePointerMove = useCallback(
        (event: any) => {
            ...
            // Handle both mouse and touch events if needed, but here simple mouse event
            const { x, y } = getOffsets(event as unknown as MouseEvent, shell);
    ...
    useEffect(() => {
        ...
        const pointerMoveHandler = (e: Event) => handlePointerMove(e);
        const pointerEnterHandler = (e: Event) => handlePointerEnter(e);
