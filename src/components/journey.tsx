                ...
                <div>
                    ...
                    <div className="space-y-6">
                        ...
                        <a
                            ...
                            className="block p-4 rounded-lg bg-neutral-900/50 border border-neutral-800 hover:bg-neutral-800 transition-all cursor-pointer group"
                        >
                        ...
                        {/* HCI Series */}
                        <a
                            href="https://hci-u6jv.vercel.app/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="block p-4 rounded-lg bg-neutral-900/50 border border-neutral-800 hover:bg-neutral-800 transition-all cursor-pointer group"
                        >
                        ...
                        {/* Todo App */}
                        <a
                            href="https://todo-tau-swart.vercel.app/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="block p-4 rounded-lg bg-neutral-900/50 border border-neutral-800 hover:bg-neutral-800 transition-all cursor-pointer group"
                        >
                        ...
                        {/* React Experiments */}
                        <a
                            href="https://visual-astronomy-navigator.vercel.app/"
                            target="_blank"
                            rel="noopener noreferrer"
                            className="block p-4 rounded-lg bg-neutral-900/50 border border-neutral-800 hover:bg-neutral-800 transition-all cursor-pointer group"
                        >
